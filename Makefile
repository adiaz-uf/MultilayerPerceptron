...
predict2:
	@venv/bin/python3 src/prediction/predict.py --dataset data/data_test.csv --model models/breast_cancer_diagnosis_v1.1.0.npz --config model_config/BreastCancerDiagnosis_config_v110.yaml

predict3:
	@venv/bin/python3 src/prediction/predict.py --dataset data/data_test.csv --model models/breast_cancer_diagnosis_v1.2.0.npz --config model_config/BreastCancerDiagnosis_config_v120.yaml
